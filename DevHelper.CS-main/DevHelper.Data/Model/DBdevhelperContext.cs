        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ArquivoProblema>(entity =>
            {
                ...
                entity.HasOne(d => d.Problema).WithMany(p => p.ArquivoProblemas)
                    ...
                    .HasConstraintName("FK__ArquivoPr__Probl__4E88ABD4"); // Aplicando DeleteBehavior.Cascade para ArquivoProblema
            });
            ...
            modelBuilder.Entity<Problema>(entity =>
            {
                ...
                entity.HasOne(d => d.Usuario).WithMany(p => p.Problemas)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Problema__Usuari__4BAC3F29"); // Mantendo DeleteBehavior.ClientSetNull para Usuario
            });
